...
public interface UserRepository extends PagingAndSortingRepository<UserEntity, Long> {
	...
	//rollback. fine to put here since we still don't invoke it from a service method or restcontroller.
	// usually done in service method
	@Transactional 
	@Modifying //for modifying queries
